package com.as3dmod.util {
	...
	public class Value {
		...
		/** Нечетное ли число? */
		public function get isOdd():Boolean { return _value % 2 == 1; }
		
		/** Четное ли число? */
		public function get isEven():Boolean { return _value % 2 == 0; }
		 ...
		 */
		public function valueOf():Number { return _value; }
		
		/**
		 * Возвращает строковое представление текущего объекта.
		 * @return	  строковое представление текущего объекта.
		 */
		public function toString():String { return _value + " " + _range.toString(); }
		 ...
		 */
		public function isFirst():Boolean {	return _value == _range.start; }
		
		/**
		 * Число является последним в диапазоне чисел?
		 * @return true -- да, false -- нет.
		 */
		public function isLast():Boolean { return _value == _range.end; }
		
		/**
		 * Число является первым или последним в диапазоне чисел?
		 * @return true -- да, false -- нет.
		 */
		public function isPolar():Boolean { return isFirst() || isLast(); }
	}
}
