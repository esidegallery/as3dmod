package com.as3dmod.modifiers {
	...
	import com.as3dmod.core.verlet.VerletConnection;
	import com.as3dmod.core.verlet.VerletVertex;
	...
	public class Cloth extends Modifier implements IModifier {
		...
		/** Удаляет все границы. */
		public function clearBounds():void { _useBounds = false; }
		
		/** Вершины, используемые для расчета анимации. Они отличаются от обычных вершин тем, что они учитывают также скорость. */
		public function get verletVertices():Vector.<VerletVertex> { return _vertices; }
		
		/** Значение трения воздуха, поступающего на ткань. */
		public function get friction():Number { return (_friction-1)*100; }
		...
		public function get rigidity():Number { return _rigidity; }
		 ...
		 */
		public function get forceX():Number { return _forceX; } 
		public function set forceX(value:Number):void { _forceX = value; }
		 ...
		 */
		public function get forceY():Number { return _forceY; } 
		public function set forceY(value:Number):void { _forceY = value; }
		
		/**
		 * Значение действия внешних сил на вершины вдоль оси Z.
		 * Может быть использовано для имитации природных эффектов, таких как, например, ветер.
		 */
		public function get forceZ():Number { return _forceZ; } 
		public function set forceZ(value:Number):void { _forceZ = value; }
