package com.as3dmod.core.verlet {
	...
	public class VerletVertex {
		...
		/** Скорость по оси X. */
		public function get velocityX():Number { return _x-_oldX; }
		public function set velocityX(value:Number):void { _oldX = _x-value; }
		
		/** Скорость по оси Y. */
		public function get velocityY():Number { return _y-_oldY; }
		public function set velocityY(value:Number):void { _oldY = _y-value; }
		
		/** Скорость по оси Z. */
		public function get velocityZ():Number { return _z-_oldZ; }
		public function set velocityZ(value:Number):void { _oldZ = _z-value; }
