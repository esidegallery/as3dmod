package com.as3dmod.core {
	...
	public class MeshProxy implements IMeshInfo {
		 ...
		 */
		public function getVertices():Vector.<VertexProxy> { return vertices; }
		
		/**
		 * Возвращает список треугольников меша. 
		 * @return	список треугольников меша. 
		 */
		public function getFaces():Vector.<FaceProxy> { return faces; }
		...
		public function get maxAxis():int { return _maxAxis; }
		/** Ось координат, вдоль которой размеры меша средние. */
		public function get midAxis():int { return _midAxis; }
		/** Ось координат, вдоль которой размеры меша минимальные. */
		public function get minAxis():int { return _minAxis; }
