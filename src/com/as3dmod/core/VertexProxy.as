package com.as3dmod.core {
	...
	public class VertexProxy {
		...
		public function get ratioZ():Number { return _ratioZ; }
		...
		public function get originalX():Number { return ox; }
		
		/** Исходная координата вершины по оси Y. */
		public function get originalY():Number { return oy; }
		
		/** Исходная координата вершины по оси Z. */
		public function get originalZ():Number { return oz; }
		...
		public function get vector():Vector3D { return new Vector3D(x,y,z); }
		...
		public function get ratioVector():Vector3D { return new Vector3D(ratioX, ratioY, ratioZ); }
	}
}